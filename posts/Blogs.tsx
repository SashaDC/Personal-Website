...
export const blogs = [
  {
    ...
    content: (
      <>
        <h2 className="text-xl font-semibold">Ethical Decision</h2>
        <p className="mb-4">
        ...
        <p className="mb-4">I tried to address the issue by:</p>
        <ul className="list-disc pl-5 mb-4">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <h2 className="text-xl font-semibold">How is EQ Different from IQ?</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold">Why is EQ Important?</h2>
        <p className="mb-4">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <h2 className="text-xl font-semibold">Elegantly Solving a Problem</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold">Reluctance to Ask for Help</h2>
        <p className="mb-4">
